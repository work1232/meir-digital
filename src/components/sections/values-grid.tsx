    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      {VALUES.map((value, i) => (
        <Reveal
          key={value.key}
          delay={i * 0.08}
          className="group rounded-2xl border border-border bg-card/60 p-6 backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-brand-2/40 hover:glow-sm"
        >
